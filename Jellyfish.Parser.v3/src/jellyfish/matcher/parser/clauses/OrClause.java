...
public final class OrClause extends CompositeClause {
    ...
    protected void buildMatchTree(AliasTreeNode parentAlias, NodeAliasList prevNodes, NodeAliasList ends, boolean last) {
        ...
        for (int i=0; i<subclauses.size(); ++i) {
            ...
            subNextNodes.clear();
            holder.subclause.buildMatchTree( aliasTreeNode, prevNodes, subNextNodes, last);
