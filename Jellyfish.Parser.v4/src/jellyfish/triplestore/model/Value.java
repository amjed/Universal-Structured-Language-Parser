	...
	extends BaseEntity
{
    ...
    protected void setFloatValue( FloatValue floatValue ) {
	setAttribute( ATTR_VALUE_TYPE, ValueType.FLOAT );
    ...
    protected void setIntegerValue( IntegerValue integerValue ) {
	setAttribute( ATTR_VALUE_TYPE, ValueType.INTEGER );
    ...
    protected void setStringValue( StringValue stringValue ) {
	setAttribute( ATTR_VALUE_TYPE, ValueType.STRING );
