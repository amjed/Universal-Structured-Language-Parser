 ...
 * @author Xevia
 */
public class TripleCollectionParser extends jellyfish.xml.XmlNodeParser<XmlTripleStore,XmlTripleStore> {

    private static final Set<Integer> VALID_INDEXES = new HashSet<Integer>(Arrays.asList( 3 ));
