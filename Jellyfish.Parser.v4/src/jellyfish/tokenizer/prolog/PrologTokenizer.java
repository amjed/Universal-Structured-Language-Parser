...
package jellyfish.tokenizer.prolog;
 ...
 */
public class PrologTokenizer implements Tokenizer {

    private enum TokenType {
        STRING, WORD, NUMBER, SYMBOL, UNKNOWN
    };
    
    private static final String SIMPLE_WORD_REGEX = "(?:[a-zA-Z_][a-zA-Z0-9_]*)";
    ...
    private static final String SYMBOL_REGEX = "([^\\sa-zA-Z0-9_])";
