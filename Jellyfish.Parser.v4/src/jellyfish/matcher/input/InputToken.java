...
public abstract class InputToken
{
    ...
    public static void addInputToken( InputTokenList outputList, TokenDictionary dictionary,
				      String input ) {
    ...
    public static void parseInputLine( InputTokenList outputList, TokenDictionary dictionary,
				       Tokenizer tokenizer, String inputLine ) {
	List<String> inputTokenStrList = new ArrayList<String>();
	tokenizer.tokenize( inputTokenStrList, inputLine );

	System.out.println( "input token list="+inputTokenStrList );
	...
	System.out.println( "output token list="+outputList );
    }

    private static class DictionaryEntryToken
	    extends InputToken
    {
    ...
    private static class StringValueToken
	    extends InputToken
    {
    ...
    private static class WildCardToken
	    extends InputToken
    {
