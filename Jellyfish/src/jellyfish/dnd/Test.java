...
public class Test extends javax.swing.JFrame {
    ...
    private JPanel createDraggablePane() {
        ...
        final String value = JOptionPane.showInputDialog("Say what?");
        ...
        pane.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                System.out.println("Clicked: "+value+" (consumed="+e.isConsumed()+")");
//                e.consume();
...
//        dragSources.add(makeDraggablePaneProducer(pane));
    ...
    private void initComponents() {
        ...
        targetPanel = new DragContainer();
        dragParent = (DragContainer)targetPanel;
        dragParent.setDragContainerListener(new TestDragContainerListener());
        ...
        chkAllowDragging.setSelected(true);
        ...
        targetPanel.addContainerListener(new java.awt.event.ContainerAdapter() {
            ...
            public void componentRemoved(java.awt.event.ContainerEvent evt) {
                targetPanelComponentRemoved(evt);
            }
        });
...
//        dragParent.addDraggableComponent(evt.getChild());
    ...
    private void targetPanelComponentRemoved(java.awt.event.ContainerEvent evt) {//GEN-FIRST:event_targetPanelComponentRemoved
    ...
    }//GEN-LAST:event_targetPanelComponentRemoved
    ...
    */
    ...
    private class TestDragContainerListener implements DragContainerListener
    {
